...
tags$main(id='app', class='layout-full-width main-content container-fluid',
  ...
  column(5, wellPanel(
                      ...
                      htmlTemplate("html/form-row__scenario-variables.html",
                        help_text = "percent of newly infected patients who are admitted to this hospital",
                      ...
                      htmlTemplate("html/form-row__scenario-variables.html",
                        help_text = "percent of newly infected patients who are admitted to the ICU",
                      ...
                      htmlTemplate("html/form-row__scenario-variables.html",
                        help_text = "percent of newly infected patients who are admitted to the hospital and require use of a ventilato",
                      ...
                      htmlTemplate("html/form-row__scenario-variables.html",
                        help_text = "percent of newly infected patients whose outcome is death",
                      ...
                      htmlTemplate("html/form-row__scenario-variables.html",
                        help_text = "percent of days spent in the ICU",
                      ...
                      htmlTemplate("html/form-row__scenario-variables.html",
                        help_text = "average length of stay (in days) in Adult Acute Care (AAC) units such as Med/Surg.",
                      ...
                      htmlTemplate("html/form-row__scenario-variables.html",
                        help_text = "average length of stay (in days) for patients who are admitted to the ICU",
                      ...
                      htmlTemplate("html/form-row__scenario-variables.html",
                        help_text = "number of days after infection that patient is admitted to AAC",
                      ...
                      htmlTemplate("html/form-row__scenario-variables.html",
                        help_text = "number of days after infection that patient is admitted to the ICU",
